...
class HookEntry : IXposedHookLoadPackage {
    ...
    private fun applyBlur() {
        ...
        val effectiveIds = synchronized(highlightedLineIds) {
            highlightedLineIds + previousHighlightIds
        }
        ...
        Log.d(TAG, "applyBlur: children=$childCount hl=${synchronized(highlightedLineIds) { highlightedLineIds.toSet() }} prev=$previousHighlightIds")
